...
function updateProduct($product)
{
    $sql = 'UPDATE product SET 
        ...
        productDescription = "'.$product->getProductDescription().'", productPrice = "'.$product->getProductPrice().' "WHERE productid = "'.$product->getProductid().'"';
...
//-------------------------------Create list of all attributes values  as $productAttribAllValues-----------------------------

    // if($product->productAttrib) {
    //     foreach ($product->productAttrib as $attribute)
    //     {
